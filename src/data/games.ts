...
export const INITIAL_GAMES: GameItem[] = [
  ...
  },
  {
    ...
    tags: ['Demolition Derby', 'Combat Racing', 'Vehicles', 'Racing', 'Explosions'],
    themeColor: '#ef4444',
    accentColor: '#facc15',
    thumbnailUrl: battleCarsCover,
    thumbnail: battleCarsCover,
  ...
  },
  {
    ...
    thumbnail: galaxyCommanderCover,
